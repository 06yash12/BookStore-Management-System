  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setPublishYear(response.data.publishYear); // fix case
        setLoading(false);
      })
      .catch((error) => {
        setLoading(false);
        ...
        <div className='flex flex-col border-2 border-sky-400 bg-white shadow-md rounded-xl w-full max-w-xl p-6'>
          <div className='mb-4'>
            ...
            <input
              ...
              className='mt-1 border border-gray-400 rounded-md px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-sky-300'
            />
          </div>
          <div className='mb-4'>
          ...
          <button
            ...
            className='bg-sky-400 hover:bg-sky-500 text-white font-semibold py-2 rounded-md transition'
          >
            Save
          </button>
        </div>
